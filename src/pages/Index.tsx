          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-white space-y-6">
              ...
              <p className="text-lg text-white/90 max-w-xl">
                Conectamos você a pontos de coleta próximos e recompensamos cada
                ação sustentável com benefícios reais em empresas parceiras.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Como funciona o EcoRecicla
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Simplificamos a reciclagem e recompensamos sua contribuição para
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="gradient-card border-0 shadow-soft p-6 space-y-4 hover:shadow-eco transition-shadow">
              ...
              <p className="text-muted-foreground">
                Localize pontos de coleta próximos a você com nosso mapa
                interativo
              </p>
            </Card>
            ...
            <Card className="gradient-card border-0 shadow-soft p-6 space-y-4 hover:shadow-eco transition-shadow">
              ...
              <p className="text-muted-foreground">
                Leve seus recicláveis e registre a entrega no app para ganhar
                pontos
              </p>
            </Card>
            ...
            <Card className="gradient-card border-0 shadow-soft p-6 space-y-4 hover:shadow-eco transition-shadow">
              ...
              <p className="text-muted-foreground">
                Use seus pontos para obter descontos em centenas de empresas
                parceiras
              </p>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              Nossa comunidade já fez a diferença. Seja parte dessa
              transformação!
            </p>
